...
//     由Class-Dump生成 .
//
//  Copyright (C) 1997-2019 MacXK. 由MacXK于2025年汉化，修改，适配.
//

@class BypSendEmotionMessageMgr, BypSendMessageMgr, CDownloadVideoMgr, CEmoticonDownloadMgr, CEmoticonUploadMgr, CMessageDB, DownloadImageCDNMgr, DownloadImageMgr, DownloadVideoCDNMgr, ImageUploadUnifyBaseMgr, MessageAssetThreshold, MessagePatternCacheMgr, MultiMediaUploadUnifyMgr, NSDate, NSMutableArray, NSMutableDictionary, NSNumber, NSObject, NSString, OpenDownloadCDNMgr, OpenDownloadMgr, OpenUploadCDNMgr, OpenUploadMgr, OpenUploadVideoCDNMgr, RecordDownloadCDNMgr, RecordUploadCDNMgr, RoomHistoryDownloadCDNMgr, ThumbDownloadMgr, UploadImageMgr, VideoUploadUnifyMgr;
...
@interface CMessageMgr
{
    ...
    _Bool _isUsingNewImageUploadMgr;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isUsingNewImageUploadMgr; // @synthesize isUsingNewImageUploadMgr=_isUsingNewImageUploadMgr;
...
- (void)onChatBotLoginAuth:(id)arg1;
...
- (void)StartUploadImageMsg:(id)arg1 MsgWrap:(id)arg2;
...
- (id)GetNotSystemMsg:(id)arg1 FromID:(unsigned int)arg2 Limit:(int)arg3;
...
- (id)GetMsgByCreateTimeAndType:(id)arg1 FromCreateTime:(unsigned int)arg2 ToCreateTime:(unsigned int)arg3 type:(id)arg4;
...
- (id)imageUploadMgrWithMsgWrap:(id)arg1;
- (id)init;
...
- (void)VoIP_supplementLocalBubbleMessageWrapToUsername:(id)arg1 withWordingId:(int)arg2 isVideo:(_Bool)arg3 roomID:(unsigned long long)arg4 roomKey:(unsigned long long)arg5 inviteID:(unsigned int)arg6 inviteID64:(unsigned long long)arg7 duration:(unsigned int)arg8 isCaller:(_Bool)arg9 needFixTime:(_Bool)arg10 createTime:(unsigned int)arg11 exceptionType:(unsigned long long)arg12 isIlink:(_Bool)arg13 callerMemberID:(int)arg14 calleeMemberID:(int)arg15;
